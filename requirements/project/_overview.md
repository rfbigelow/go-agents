...
at M2 and still in progress) → Conversation Resumption (M9) → Context
Compaction (M10), whose archival path builds on the M9 resumption
round-trip. M1–M5 and M7–M10 are complete; M6 remains the open milestone.
No hard deadlines — pace is driven by available time and learning goals.
See P3 for details.
